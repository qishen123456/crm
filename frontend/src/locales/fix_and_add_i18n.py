...
tips_by_locale = {
  "zh-CN": '演示：任意已设置邮箱 + 密码 "demo2026"',
  "zh-HK": '演示：任意已設置電郵 + 密碼 "demo2026"',
  "en-US": 'Demo: any email + password "demo2026"',
  "th-TH": 'เดโม: อีเมลที่ตั้งค่าไว้ + รหัสผ่าน "demo2026"',
  "id-ID": 'Demo: email apa pun yang terdaftar + kata sandi "demo2026"',
  "vi-VN": 'Demo: bất kỳ email đã thiết lập + mật khẩu "demo2026"',
  "fr-FR": 'Demo: tout email + mot de passe "demo2026"',
}
...
for locale, trans in translations.items():
    ...
    # Fix broken login.tips line if present
    tips = tips_by_locale[locale]
    # Replace any line starting with "tips" inside login block, preserving indent and keeping submit line
    text = re.sub(
        r'^(\s+"tips":\s*)".*$\n(\s+"submit":)',
        rf'\1"{tips}",\n\2',
        text,
